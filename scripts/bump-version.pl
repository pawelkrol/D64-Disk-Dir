...
Updating version number and release date of the D64::Disk::Dir package:
...
$command = sprintf q{sed -i -e "s/D64::Disk::Dir Version [0-9]\\+\\.[0-9]\\+/D64::Disk::Dir Version %s/" README}, $new_version;
